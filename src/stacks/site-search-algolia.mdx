...
Note: if you're using a framework like Rails or CMS like WordPress, or just have your content neatly organized in a database, there's likely a better way to get your data into Algolia than crawling your site. See here for [more information](/app-search-algolia).
...
<Tools>
  ...
  <GitHub name="matthewmueller/x-ray" {...props}>
...
<Tools>
  ...
  <GitHub name="algolia/vue-instantsearch" {...props}>
    The Vue.js version of InstantSearch.
  </GitHub>
  <GitHub name="algolia/angular-instantsearch" {...props}>
