...
<Category>
  <Tool name="DeuxHuitHuit/algolia-webcrawler" {...props}></Tool>
  <Tool name="algolia/docsearch" {...props}></Tool>
  <Tool name="scrapy/scrapy" {...props}></Tool>
</Category>
...
<Category>
  <Tool name="algolia/algoliasearch-client-javascript" {...props}></Tool>
  <Tool name="algolia/algoliasearch-client-python" {...props}></Tool>
</Category>
