...
<Tools>
  <Tool name="algolia/awesome-algolia" {...props}>
...
<Tools>
  <Tool name="DeuxHuitHuit/algolia-webcrawler" {...props}>
    Handles both the crawler and the formatting and uploading of records.
  </Tool>
  <Tool name="algolia/docsearch" {...props}>
...
<Tools>
  <Tool name="algolia/algoliasearch-client-javascript" {...props}>
    Algolia Search API Client for JavaScript platforms
  </Tool>
  <Tool name="algolia/algoliasearch-client-python" {...props}>
...
<Tools>
  <Tool name="algolia/jekyll-algolia" {...props}>
    An official Algolia-supported way to create a search for websites based on jekyll.
  </Tool>
  <Tool name="algolia/gatsby-plugin-algolia" {...props}>
  ...
  <Tool name="10Dimensional/hugo-algolia" {...props}>
...
<Tools>
  ...
  <Tool name="Shipow/searchbox" {...props}>
